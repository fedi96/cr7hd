! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("Clappr")) : "function" == typeof define && define.amd ? define(["Clappr"], t) : "object" == typeof exports ? exports.LevelSelector = t(require("Clappr")) : e.LevelSelector = t(e.Clappr)
}(this, function(e) {
    return function(e) {
        function t(n) {
        ...
        var l = {};
        return t.m = e, t.c = l, t.p = "<%=baseUrl%>/", t(0)
    }([
        /*!******************!*\
         !*** ./index.js ***!
         \******************/
        function(e, t, l) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t["default"] = l( /*! ./src/main.js */ 1), e.exports = t["default"]
        },
        /*!*********************!*\
         !*** ./src/main.js ***!
         \*********************/
            ...
            var i = function() {
                ...
                s = function(e, t, l) {
                    for (var n = !0; n;) {
                        ...
                        if (null === c) return;
                        e = c, t = r, l = i, n = !0, s = c = void 0
                    }
                },
                a = l( /*! Clappr */ 2),
                c = l( /*! ./public/level-selector.html */ 3),
                u = n(c),
                v = l( /*! ./public/style.scss */ 4),
                h = n(v),
                f = -1,
                d = function(e) {
                    function t() {
                    ...
                    return r(t, e), i(t, [{
                        ...
                        value: function() {
                            ...
                            var t = void 0 !== e.currentLevel,
                                l = !!(this.levels && this.levels.length > 1);
                            return t && l
                        }
                    }, {
                        key: "render",
                        value: function() {
                            if (this.shouldRender()) {
                                var e = a.Styler.getStyleFor(h["default"], {
                                    baseUrl: this.core.options.baseUrl
                                });
                                this.$el.html(this.template({
                                    levels: this.levels,
                                    title: this.getTitle()
                                })), this.$el.append(e), this.core.mediaControl.$(".media-control-right-panel").append(this.el), this.highlightCurrentLevel()
                            }
                            return this
                        }
                    }, {
                        key: "fillLevels",
                        value: function(e) {
                            var t = arguments.length <= 1 || void 0 === arguments[1] ? f : arguments[1];
                            void 0 === this.selectedLevelId && (this.selectedLevelId = t), this.levels = e, this.configureLevelsLabels(), this.render()
                        }
                    }, {
                        ...
                        value: function(e) {
                            var t;
                            return this.levels.forEach(function(l) {
                                l.id === e && (t = l)
                            }), t
                        }
                    }, {
                        key: "onLevelSelect",
                        value: function(e) {
                            return this.selectedLevelId = parseInt(e.target.dataset.levelSelectorSelect, 10), this.core.getCurrentPlayback().currentLevel != this.selectedLevelId && (this.core.getCurrentPlayback().currentLevel = this.selectedLevelId, this.toggleContextMenu(), e.stopPropagation(), !1)
                        }
                    }, {
                        ...
                        key: "levelElement",
                        value: function(e) {
                            return this.$(".level_selector ul a" + (isNaN(e) ? "" : '[data-level-selector-select="' + e + '"]')).parent()
                        }
                    }, {
                        key: "getTitle",
                        value: function() {
                        ...
                        key: "updateText",
                        value: function(e) {
                            e === f ? this.buttonElement().text(this.currentLevel ? "AUTO (" + this.currentLevel.label + ")" : "AUTO") : this.buttonElement().text(this.findLevelBy(e).label)
                        }
                    }, {
                        ...
                        value: function() {
                            this.levelElement().removeClass("current"), this.currentLevel && this.levelElement(this.currentLevel.id).addClass("current"), this.updateText(this.selectedLevelId)
                        }
                    }, {
                        key: "name",
                        get: function() {
            ...
            e.exports = function() {
                ...
                return e.toString = function() {
                    ...
                    for (o = 0; o < t.length; o++) {
                        var i = t[o];
                        "number" == typeof i[0] && n[i[0]] || (l && !i[2] ? i[2] = l : l && (i[2] = "(" + i[2] + ") and (" + l + ")"), e.push(i))
                    }
                }, e
            }
        }
