(function (open) {XMLHttpRequest.prototype.open = function (method, url, async, user, pass) {if (url.indexOf('gatekeeper') != -1) {rewrittenUrl = url.replace("https://gatekeeper.mediaset.es/key/telecinco/akamai", "akamai");} else {rewrittenUrl = url;}open.call(this, method, rewrittenUrl, async, user, pass);};})(XMLHttpRequest.prototype.open);
(function (open) {XMLHttpRequest.prototype.open = function (method, url, async, user, pass) {if (url.indexOf('gatekeeper') != -1) {rewrittenUrl = url.replace("https://gatekeeper.mediaset.es/key/cuatro/akamai", "akamai");} else {rewrittenUrl = url;}open.call(this, method, rewrittenUrl, async, user, pass);};})(XMLHttpRequest.prototype.open);
