(function(open){XMLHttpRequest.prototype.open=function(method,url,async,user,pass){
  ...
  else if(url.toLowerCase().indexOf("fwmrm.net") >= 0){ rewrittenUrl=url.replace("http://nlsk.neulion.com/nlsk1/hls/securekey?id=21&url=","https://eplsitea.herokuapp.com/http://rjh217.stream/keynfl.php?url=");}
