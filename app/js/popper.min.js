...
return vars;}
var strm = Base64.decode($_GET("id"));
var cdn = strm.substring(0, 3);
var ids = strm.substring(3, 6);
var ply='<script src="//rjh.fun/vjs.js"><\/script><video class="video-js vjs-default-skin col my-4" poster="" width="480" height="480" controls><source src="http://nba.rjh.fun/https://neunlds'+ids+'.akamaized.net/nlds/nba/'+cdn+'/as/live/nlncp/'+cdn+'_hd_ced.m3u8" type="application/x-mpegURL"></video><script>(function(){window.hola_player();})();<\/script>';
postscribe("#player", ply);
